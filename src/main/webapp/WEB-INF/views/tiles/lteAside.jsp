...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
   <!-- Brand Logo -->
   <a href="/resources/adminlte3/index3.html" class="brand-link"> <img
	         ...
	         <div class="info">
	            <a href="#" class="d-block">${userName}(${userId})님 환영합니다.</a>
		          <form action="/logout" method="post">
	                <button type="submit" class="btn btn-block bg-gradient-primary btn-sm">Log out</button>
	                <sec:csrfInput/>
		          </form>
		         </div>
		      </div>
