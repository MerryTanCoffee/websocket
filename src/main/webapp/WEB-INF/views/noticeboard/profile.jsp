				...
				<div class="card card-primary card-outline">
					<div class="card-body box-profile">
						...
						<ul class="list-group list-group-unbordered mb-3">
							<li class="list-group-item"><b>공지사항</b> 
							<a class="float-right">356</a></li>
							<li class="list-group-item"><b>자유게시판</b> 
							<a class="float-right">150</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="card-body">
						<div class="tab-content">
							<div class="tab-pane active" id="settings">
								<form class="form-horizontal" action="/notice/profileUpdate.do" enctype="multipart/form-data" method = "post" id="profileUdtForm">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											...
											placeholder="아이디를 입력해주세요." value="${member.memId }" readonly="readonly">
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-10">
											...
											placeholder="비밀번호를 입력해주세요." value="${member.memPw }">
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<div class="input-group mb-3">
												<input type="text" class="form-control" id="memPostCode" name="memPostCode" 
													placeholder="우편번호를 입력해주세요" value="${member.memPostCode }"> <span
											...
											<div class="input-group mb-3">
												...
												id="memAddress1" name="memAddress1"	value="${member.memAddress1 }" placeholder="주소를 입력해주세요">
											</div>
											<div class="input-group mb-3">
												<input type="text" class="form-control"
												id="memAddress2" name="memAddress2"	value="${member.memAddress2 }" placeholder="상세주소를 입력해주세요">
											</div>
										</div>
									</div>
									<div class="form-group row">
